...
class ScenarioGenerator:
    def gen(self, theme: str, style: str, duration: int, extra: str = "", lang = "ru"):
        ...
...
data = deep_exclude_key(data, "hierarchy_id")

info = "Напиши мне сценарий про римскую империю, на 5 минут чтения текста вслух. Мне нужен только JSON вот по такому шаблону. " + str(data) + " Кол-во эпизодов сиквенсов и шотов сам выбирай."
